<template>
  <div class="project-card" @mouseover="hovered = true" @mouseleave="hovered = false">
    <div class="project-img-container">
      <img :src="projectDetails.imageUrl" width="535" height="261" alt="project image" loading="lazy" />
    ...
    <TransitionRoot :show="hovered" as="template" appear enter="transform transition duration-700"
      enter-from="-translate-y-full" enter-to="translate-y-0" leave="transform duration-500 transition ease-in-out"
        ...
        <div class="stack-and-project-links">
          <div class="tech-stack-container">
            <div v-for="(tech, index) in projectDetails.techStack" :key="tech">
              <p>
                {{ tech
                }}<span v-if="index !== projectDetails.techStack.length - 1">&#183;</span>
              </p>
            </div>
          </div>
          <div class="project-links">
            <a v-if="projectDetails.isUrl" :href="projectDetails.urlLink" target="blank" class="cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                class="bi bi-arrow-up-right-square-fill w-5 h-5 hover:text-gray-600 rounded" viewBox="0 0 16 16">
                <path
            ...
            <a class="mx-2" :href="projectDetails.githubLink" target="blank" aria-label="Github">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                class="bi bi-github w-5 h-5 hover:text-gray-600" viewBox="0 0 16 16">
                <path
