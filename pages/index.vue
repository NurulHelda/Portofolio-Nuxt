<template>
  <NuxtLayout name="default">
    <div>
      <Modal :is-open="isOpen" :close-modal="closeModal" :modal-content="currentModalContent" />
      <Header />
      <TextLeftImgRight />
      <Skills :skill-set="skillSet" />
      <WorkSection :working-projects="workingProjects" :on-click-function="showModal" />
      <div id="projects"></div>
...
<script setup>
  ...
  const projects = [{
    ...
    },
    {
      ...
      description: "This project uses Tensorflow.js which is an open source Machine Learning. Where this project helps perform facial recognition, detection of facial expressions, and detection of gender and age estimation.",
      techStack: [
        "JavaScript",
        "HTML",
        "TensorFlow",
    ...
    },
    {
      ...
      description: "Fully Responsive web project with the aim to reach a wider market and manage business more easily and efficiently.",
      techStack: [
        "PHP",
        "HTML",
        "CSS",
    ...
    },
    {
      ...
      description: "Artificial intelligence project for finger tracking using Python.",
      techStack: ["Python"],
      isUrl: false,
